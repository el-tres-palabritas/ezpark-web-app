      ...
      <form @submit.prevent>
        <div class="register-form-section--top">
          <div class="register-form-field register-form-field--address">
            ...
            <v-google-autocomplete @placeChanged="handleAutocompletePlaceChanged" />
          </div>
        ...
        <div class="register-form-section--bottom">
          <div class="register-form-additional-info">
            ...
            <div class="register-form-field">
              <label for="address">Height (m):</label>
              <pv-input-text />
            </div>
            <div class="register-form-field">
              <label for="startTime">Start time:</label>
              <pv-input-mask mask="99:99" />
            </div>
            <div class="register-form-field">
            ...
            <div class="register-form-field">
              ...
              <pv-input-mask mask="999-999-999" />
            </div>
          </div>
          <div class="register-form-cta">
            ...
            <pv-button class="register-form-post-btn" label="Post parking" severity="contrast" />
          </div>
        </div>
      </form>
    </section>
